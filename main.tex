...
The model can be applied to the topological changes of sublimation-deposition process of ETM in the sense that mean curvature flow can be closely related to this process.
