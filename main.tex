...
Under those conditions, ETM is classically described by the following set of equations. Using the Hertz-Knudsen equation vapor density can be linked to the growth speed of the interface $\Gamma$:\\
\begin{subequations}
\begin{align}
