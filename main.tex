...
\end{align}
\begin{align}
v_{k i n} &= \frac{\rho_{v s}^{\mathrm{f}}}{\rho_i}\sqrt{\frac{k T}{2 \pi m}} % vérifier la formulation de vkin ?
\end{align}
\end{subequations}
...
\begin{subequations}
\begin{align}
\mathbf{k}_{\mathrm{Calonne\ 2011}}=2.5 \times 10^{-6} \rho_{\mathrm{s}}^{2}-1.23 \times 10^{-4} \rho_{\mathrm{s}}+0.024\end{align}
\begin{align}
