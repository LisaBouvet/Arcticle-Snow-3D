...
\hline
\end{tabular}
\caption{Experimental ETM series used to calibrate and evaluate the model. The density corresponds to the initial density of the used part of each series. The snow types separated by an arrow present the initial and final type of the series.}
...
\hline
\end{tabular}
\caption{Experimental images used as prediction to simulate ETM.}
